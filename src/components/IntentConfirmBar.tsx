...
import { applyIntent, IntentType } from '../services/intentApply';
...
export const IntentConfirmBar: React.FC = () => {
  ...
  const choose = async (id: string, type: IntentType) => {
